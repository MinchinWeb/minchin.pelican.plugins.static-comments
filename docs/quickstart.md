...
1. Merge the `./theme` folder with your own theme folder, or copy the files
   manually
...
3. Enable the plugin: `pelicanconf.py` (See also [How to use
   plugins](https://github.com/getpelican/pelican-plugins/tree/master/#how-to-use-plugins))
